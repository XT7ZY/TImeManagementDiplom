...
(function ($) {
    ...
    function calendar($el, options) {
        ...
        function monthAddEvent(index, event) {
            ...
            if (!event.end) {
                $event.addClass('begin end bg-success text-white');  ////////////////////////////////////////////////////////////////////////////////////// bg-success text-white
    ...
    ; (function (defaults, $, window, document) {
        ...
        shortMonths: ["Янв", "Февр", "Март", "Апр", "Май", "Июнь", "Июль", "Авгст", "Сен", "Окт", "Нояб", "Дек"],
        date: (new Date()),
...
data.push({ title: 'Ситников Владислав Васильевич', start: new Date("May 25, 2023 00:00:00"), end: end, allDay: 1, text: "Моё событие" });
data.push({ title: 'Ситников Владислав Васильевич', start: new Date("May 24, 2023 00:00:00"), end: end, allDay: 1, text: "Моё событие1" });
data.push({ title: 'Ситников Владислав Васильевич', start: new Date("June 6, 2023 00:00:00"), end: end, allDay: 1, text: "Моё событие2" });
data.push({ title: 'Ситников Владислав Васильевич', start: new Date("May 23, 2023 00:00:00"), end: end, allDay: 1, text: "Моё событие3" });
data.push({ title: 'Ситников Владислав Васильевич', start: new Date("May 26, 2023 00:00:00"), end: end, allDay: 1, text: "Моё событие3" });
data.push({ title: 'Ситников Владислав Васильевич', start: new Date("May 27, 2023 00:00:00"), end: end, allDay: 1, text: "Моё событие3" });
data.push({ title: 'Ситников Владислав Васильевич', start: new Date("May 28, 2023 00:00:00"), end: end, allDay: 1, text: "Моё событие3" });
data.push({ title: 'Ситников Владислав Васильевич', start: new Date("May 22, 2023 00:00:00"), end: end, allDay: 1, text: "Моё событие3" });
data.push({ title: 'Ситников Владислав Васильевич', start: new Date("May 21, 2023 00:00:00"), end: end, allDay: 1, text: "Моё событие3" });
data.push({ title: 'Глухов Александр', start: new Date("May 21, 2023 00:00:00"), end: end, allDay: 1, text: "Моё событие3" });
data.push({ title: 'Глухов Александр', start: new Date("May 22, 2023 00:00:00"), end: end, allDay: 1, text: "Моё событие3" });
data.push({ title: 'Глухов Александр', start: new Date("May 23, 2023 00:00:00"), end: end, allDay: 1, text: "Моё событие3" });
data.push({ title: 'Глухов Александр', start: new Date("May 24, 2023 00:00:00"), end: end, allDay: 1, text: "Моё событие3" });
